...
### Fixed
- Added compilation step (`npm run build`) in `action.yml` to prevent `MODULE_NOT_FOUND` errors when running the composite Action in external repositories.

### Changed
- Updated documentation examples to reference `@v1.1.3`.
